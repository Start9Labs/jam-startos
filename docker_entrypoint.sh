...
export JM_RPC_WALLET_FILE="jam_wallet"
export JM_RPC_HOST="bitcoind.embassy"
export DATADIR="/data/.joinmarket"
export DEFAULT_CONFIG="/data/default.cfg"
export CONFIG="/data/.joinmarket/joinmarket.cfg"
#export LOGDIR="/data/.joinmarket/logs"
...
#Copy in default config from docker image
cp -f /root/default.cfg /data/default.cfg
